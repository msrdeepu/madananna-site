                        ...
                        <ul class="list-inline mb-0">
                            ...
                            <li class="list-item mb-3">
                                <a href="#" class="text-white"> <i
                                        class="fas fa-fw fa-map-marker-alt me-2 mt-1"></i>Chicago HQ Estica Cop. Macomb, MI
                                    48042 </a>
                            </li>
                            <!-- Phone number -->
                            <li class="list-item mb-3">
                    ...
                    <div class="card card-body shadow py-5 text-center h-100">
                        ...
                        <ul class="list-inline mb-0">
                            ...
                            <li class="list-item mb-3 h6 fw-light">
                                <a href="#"> <i class="fas fa-fw fa-map-marker-alt me-2 mt-1"></i>2492 Centennial NW,
                                    Acworth, GA, 30102 </a>
                            </li>
                            <!-- Phone number -->
                            <li class="list-item mb-3 h6 fw-light">
                ...
                <div class="col-lg-4 mt-lg-0">
                    <div class="card card-body shadow py-5 text-center h-100">
                        ...
                        <ul class="list-inline mb-0">
                            <!-- Address -->
                            <li class="list-item mb-3 h6 fw-light">
                                <a href="#"> <i class="fas fa-fw fa-map-marker-alt me-2 mt-1"></i>2002 Horton Ford Rd,
                                    Eidson, TN, 37731 </a>
                            </li>
                            <!-- Phone number -->
                            <li class="list-item mb-3 h6 fw-light">
        ...
        <div class="container">
            <div class="row g-4 g-lg-0 align-items-center">
                ...
                <div class="col-md-6 align-items-center text-center">
                    <!-- Image -->
                    <img src="{{ asset('backend/frontassets/assets/images/element/contact.svg') }}" class="h-400px"
                        alt="">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-center mt-2 mt-sm-4">
                        ...
                        <ul class="list-inline mb-0 ms-sm-2">
                            <li class="list-inline-item"> <a class="fs-5 me-1 text-facebook"
                                    href="{{ config('sitevars.fblink') }}"><i class="fab fa-fw fa-facebook-square"></i></a>
                            </li>
                            <li class="list-inline-item"> <a class="fs-5 me-1 text-instagram"
                                    href="{{ config('sitevars.instalink') }}"><i class="fab fa-fw fa-instagram"></i></a>
                            </li>
                            ...
                            <li class="list-inline-item"> <a class="fs-5 me-1 text-linkedin"
                                    href="{{ config('sitevars.linkedinlink') }}"><i
                ...
                <div class="col-md-6">
                    <!-- Title -->
                    <h2 class="mt-4 mt-md-0">Let's Connect</h2>
                    <p>It is amazing to see you here. We are here to assist you. Please submit your query by submitting the
                        following form. Our team will contact you soon.</p>

                    <form action="{{ route('create.contact') }}" class="row" method="POST">
                        @csrf
                        <!-- Name -->
                        <div class="mb-4 bg-light-input col-md-6">
