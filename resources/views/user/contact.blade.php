                    ...
                    <div class="row pb---96">
                        <div class="col-lg-4 pt---10">
                            <ul class="address-sec">
                                <li>
                                    <em class="icon"><img src="assets/images/contact/2.png" alt="image"></em>
                                    <span class="text"><em>Address</em> 1800 Abbot Kinney Blvd. Unit D<br> & E
                                        Venice</span>
                                </li>
                                <li>
                                    <em class="icon"><img src="assets/images/contact/3.png" alt="image"></em>
                                    <span class="text"><em>Contact</em> <a href="#">Mobile: (+88) - 1990 - 6886</a>
                                        <a href="#">Mail: contact@echooling.com</a></span>
                                </li>
                                <li>
                                    <em class="icon"><img src="assets/images/contact/4.png" alt="image"></em>
                                    <span class="text"><em>Hour of operation</em> Monday - Friday: 09:00 - 20:00
                                        <br>Sunday & Junday: 10:30 - 22:00</span>
                                </li>
                            </ul>
                        </div>
                        <div class="col-lg-8">
                                ...
                                <div id="blog-form" class="blog-form">
                                    ...
                                    <form id="contact-form">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <button type="submit" class="back-btn g-recaptcha"
                                                    data-sitekey="{{ config('services.recaptcha.key') }}"
                                                    data-callback='onSubmit' data-action='submit'>Send Message <svg
