        ...
        <div class="container-fluid px-3 px-xl-5">
            ...
            <div class="navbar-collapse w-100 collapse" id="navbarCollapse">
                ...
                <ul class="navbar-nav navbar-nav-scroll me-auto">
                    <!-- Nav item 1 Demos -->
                    <li class="nav-item">
                        <a class="nav-link active" href="/" id="demoMenu" aria-haspopup="true"
                    ...
                    <!-- Nav item 4 Megamenu-->
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('main.allquizzes') }}" aria-haspopup="true"
                            aria-expanded="false">Play Quiz</a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="/page/about-us" id="pagesMenu" aria-expanded="false">About</a>

                    </li>

                    <!-- Nav item 3 Account -->
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="{{ route('create.contact') }}" id="accounntMenu" aria-haspopup="true"
